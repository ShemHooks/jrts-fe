...
<div
  className={`
    ...
    min-h-screen w-72 bg-[#F9F8F6] shadow-inner
    flex flex-col p-6
...
>
  ...
  {/* Logout Button - pushed automatically to bottom */}
  <button
    onClick={handleLogout}
    className="mt-auto flex items-center gap-3 border border-gray-200 p-3 rounded-md text-red-500 hover:bg-red-100 transition"
  >
    <LogOut size={18} />
    Logout Account
  </button>
